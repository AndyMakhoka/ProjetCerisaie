...
<div class="well">
    ...
    <div class="form-group">
        ...
        <input required type ="date" name="DatedebSej" id ="DatedebSej" class="form-control" min="0">
    </div>
    <script>$("#DatedebSej").datepicker();</script>
    <div class="form-group">
        <label for="DateFinSej"> Date de fin :</label>
        <input required type ="date" name="DateFinSej" id ="DateFinSej" class="form-control" min="0">
    </div>
     <script>$("#DateFinSej").datepicker();</script>
    <div class="form-group">
        <label for="NbPersonnes">Nombre de personnes :</label>
        <input required type="text" class="form-control" name="NbPersonnes" value="">
    </div>
    <div class="form-group">
